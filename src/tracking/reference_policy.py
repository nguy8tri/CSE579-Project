...
def optimize(trk_params : TrackingParameters, settling_time : float = 0.1, overshoot : float = 0.05) -> Tuple[float, float, float]:
    '''
...
class TrackingReferencePolicy:
    def __init__(self, trk_params : TrackingParameters, settling_time : float = 0.1, overshoot : float = 0.05):
        ...
        """
        self.B, self.K = optimize(trk_params, settling_time, overshoot)
